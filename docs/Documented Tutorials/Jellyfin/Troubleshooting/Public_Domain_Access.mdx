...
# Or check Jellyfin log files (get the most recent log)
Get-ChildItem "$env:PROGRAMDATA\Jellyfin\Server\log\*.log" | Sort-Object LastWriteTime -Descending | Select-Object -First 1 | Get-Content -Tail 50
```
