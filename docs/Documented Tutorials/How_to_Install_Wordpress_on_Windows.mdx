...
```cmd
REM Download latest MariaDB LTS automatically
curl -L -o "%TEMP%\mariadb-latest-winx64.msi" "https://downloads.mariadb.org/f/mariadb-10.11/winx64-packages/mariadb-winx64.msi"
...
echo Extracting PHP...
tar -xf "%TEMP%\php-latest-nts-Win32-vs16-x64.zip" -C "C:\Tools\PHP" --strip-components=0
...
for /d %%i in ("C:\Program Files\MariaDB*") do set "MARIADB_PATH=%%i"
"%MARIADB_PATH%\bin\mysql.exe" -u root -p"SecureRootPassword123!" < "%TEMP%\setup_db.sql"
...
for /d %%i in ("C:\Program Files\MariaDB*") do set "MARIADB_PATH=%%i"
set "MARIA_DATA_PATH=%MARIADB_PATH%\data"

REM Create MariaDB configuration file
echo [mysqld] > "%MARIA_DATA_PATH%\my.ini"
echo # Basic Settings >> "%MARIA_DATA_PATH%\my.ini"
echo bind-address = 127.0.0.1 >> "%MARIA_DATA_PATH%\my.ini"
echo port = 3306 >> "%MARIA_DATA_PATH%\my.ini"
echo datadir = %MARIA_DATA_PATH:\=/% >> "%MARIA_DATA_PATH%\my.ini"
echo. >> "%MARIA_DATA_PATH%\my.ini"
echo # Performance Settings >> "%MARIA_DATA_PATH%\my.ini"
echo innodb_buffer_pool_size = 1G >> "%MARIA_DATA_PATH%\my.ini"
echo innodb_log_file_size = 256M >> "%MARIA_DATA_PATH%\my.ini"
echo innodb_flush_log_at_trx_commit = 2 >> "%MARIA_DATA_PATH%\my.ini"
echo innodb_flush_method = O_DIRECT >> "%MARIA_DATA_PATH%\my.ini"
echo. >> "%MARIA_DATA_PATH%\my.ini"
echo # Security Settings >> "%MARIA_DATA_PATH%\my.ini"
echo skip-name-resolve >> "%MARIA_DATA_PATH%\my.ini"
echo sql_mode = STRICT_TRANS_TABLES,NO_ZERO_DATE,NO_ZERO_IN_DATE,ERROR_FOR_DIVISION_BY_ZERO >> "%MARIA_DATA_PATH%\my.ini"
echo. >> "%MARIA_DATA_PATH%\my.ini"
echo # Character Set >> "%MARIA_DATA_PATH%\my.ini"
echo character-set-server = utf8mb4 >> "%MARIA_DATA_PATH%\my.ini"
echo collation-server = utf8mb4_unicode_ci >> "%MARIA_DATA_PATH%\my.ini"
echo. >> "%MARIA_DATA_PATH%\my.ini"
echo # Logging >> "%MARIA_DATA_PATH%\my.ini"
echo log-error = %MARIA_DATA_PATH:\=/%/error.log >> "%MARIA_DATA_PATH%\my.ini"
echo slow_query_log = 1 >> "%MARIA_DATA_PATH%\my.ini"
echo slow_query_log_file = %MARIA_DATA_PATH:\=/%/slow.log >> "%MARIA_DATA_PATH%\my.ini"
echo long_query_time = 2 >> "%MARIA_DATA_PATH%\my.ini"
echo ✅ MariaDB configuration updated at %MARIA_DATA_PATH%\my.ini
```
