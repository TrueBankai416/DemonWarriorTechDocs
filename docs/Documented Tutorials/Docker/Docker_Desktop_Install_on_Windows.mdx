...
tags: [docker, windows, installation, tutorial, containers, wsl2]
---
...
2. Open Task Manager and See if Virtualization is running

![image](https://user-images.githubusercontent.com/35183970/214379760-2a63886b-2a0c-48d1-b343-c8a4af61e308.png)

3. If it is on continue to step 4. If it is not you need to enable it in bios.

   3.1 Here's a good Tutorial for all Motherboard Manufacturers:  
...
5. Turn on the following features:
   ...
   5.3 Windows Hypervisor Platform
   5.4 Windows Subsystem Linux
...
it says the name add that in the code ie. Ubuntu-22.04 

```css
wsl --set-version Ubuntu-22.04 2
```

## Step 3: Installing and Setting up Docker-Desktop

1. Download [Docker-Desktop](https://www.docker.com/products/docker-desktop/)
2. Click through the Installer
3. Once installed Run the Docker-Desktop **(NOTE IT MAY TAKE SOME TIME TO FIRST START DEPENDING ON YOUR HARDWARE)** 

### Extra Docker Setup Configs

#### Limiting Docker's RAM Usage
...
If you are having issues with when you reboot and it not saving your containers or completely corrupting them, all you need to do is:

1. **Fully remove Docker Desktop** and **restart your computer**
