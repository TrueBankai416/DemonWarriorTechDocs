...
### Step 4: macOS Installation

#### Download and Install

```bash
# Download Tailscale for macOS
curl -o tailscale-macos.zip https://pkgs.tailscale.com/stable/tailscale-latest-macos.zip

# Extract and install
unzip tailscale-macos.zip
...
### Step 7: Exit Node Configuration
...
### Step 8: Subnet Routing Configuration
