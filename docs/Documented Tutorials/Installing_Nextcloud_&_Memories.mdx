...
description: Complete guide to installing Nextcloud with Memories app for photo management, including Docker setup, custom Dockerfile, and configuration
sidebar_position: 2
toc_min_heading_level: 2
toc_max_heading_level: 6
tags: [nextcloud, memories, docker, photo-management, self-hosting, cloud-storage, tutorial, installation]
---
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/1UEsUucYjmE?si=QBbvhz8Bf0Pr3Zsr" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
  ...
  <TabItem value="Installing Nextcloud" label="Written Instructions">

**Step-by-step Installation:**

1. Make a directory inside C:\Tools called Nextcloud
2. You need to make 3 files inside your Nextcloud Directory. You can get the code that needs to go in these files from here. [Nextcloud Building Files](/Examples/Docker_Examples#nextcloud-example)
...
1. Now we need 2 more apps from the app store. So we go to Administrative Panel --> Apps ---> Recognize
