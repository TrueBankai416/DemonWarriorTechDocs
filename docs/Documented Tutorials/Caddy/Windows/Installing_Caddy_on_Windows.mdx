...
1. **Create CloudFlare DDNS directory**:
   ```cmd
   mkdir C:\Tools\CloudFlareDDNS
   cd C:\Tools\CloudFlareDDNS
   ```

2. **Download the automated scripts using CMD**:
   ```cmd
   curl -o cloudflare-ddns-automated.bat https://raw.githubusercontent.com/TrueBankai416/DemonWarriorTechDocs/main/scripts/Cloudflare/cloudflare-ddns-automated.bat
   curl -o log-cleanup.bat https://raw.githubusercontent.com/TrueBankai416/DemonWarriorTechDocs/main/scripts/Cloudflare/log-cleanup.bat
   ```
...
6. **Check the log file** at `./logs/cloudflare-ddns.log` for entries like:
   ...
   [2025-09-20 18:26:13] Current public IP: 185.203.219.107 
   ...
   [2025-09-20 18:26:18] DEBUG: Found A record: adguard.demonwarriortech.com -> 251.790.215.7 (Proxied: True)
   [2025-09-20 18:26:18] INFO: Record needs update: adguard.demonwarriortech.com (251.790.215.7 -> 185.203.219.107)
   [2025-09-20 18:26:18] DEBUG: Found A record: jellyfin.demonwarriortech.com -> 251.790.215.7 (Proxied: False)
   ```
